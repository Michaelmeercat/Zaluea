...
(function () {
  ...
  const E = {
    ...
    breaker: { id: 'breaker', name: 'Firewall Breaker', hp: 95, speed: 40, r: 16, reward: 12, leak: 3, armor: 5, color: '#9aa7b8',
      traits: ['Heavy armor: reduces physical damage by 5 per hit.', 'Explosives ignore half; energy & toxic ignore all.'] },
    ...
    trojanx: { id: 'trojanx', name: 'Trojan (Unpacked)', hp: 190, speed: 88, r: 15, reward: 22, leak: 5, armor: 3, color: '#ff3d6e',
    ...
    // ─── Bosses
    ram: { id: 'ram', name: 'RAM CRUSHER', boss: true, hp: 2300, speed: 24, r: 34, reward: 400, leak: 100, armor: 6, color: '#5aa0ff',
      traits: ['Boss. Heavily armored.', 'Shockwave disables nearby towers every 8s.'] },
    worm: { id: 'worm', name: 'THE WORM', boss: true, hp: 3000, speed: 34, r: 24, reward: 500, leak: 100, armor: 4, segments: 9, color: '#9dff5a',
      traits: ['Boss. Long segmented body.', 'Each living segment adds armor to the head and spawns Zip Files.', 'Destroy segments to weaken it.'] },
    wormseg: { id: 'wormseg', name: 'Worm Segment', hp: 480, speed: 34, r: 17, reward: 40, leak: 5, armor: 2, color: '#6fd644',
      traits: ['Part of THE WORM.'] },
    blackout: { id: 'blackout', name: 'BLACKOUT', boss: true, hp: 7000, speed: 30, r: 32, reward: 700, leak: 120, color: '#8a5cff',
